...
const Notes = (props) => {
  ...
  const handleclick = (e) => {
    ...
    alertt("Notes updated sucessfully", 'success')
  }
    ...
    <>
      ...
      <div className='row'>
        ...
        {notes.map((note) => {
          ...
          return <Notesitem title={note.title} description={note.description} key={note._id} note={note} update={update} alertt={alertt} />
